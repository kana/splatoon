...
var WeaponSets = [
  ...
  {type: 'shooter', main: '.96ガロン', sub: 'スプリンクラー', special: 'スーパーセンサー', penalty: '小'},
  {type: 'shooter', main: '.96ガロンデコ', sub: 'スプラッシュシールド', special: 'ダイオウイカ', penalty: '大'},
  ...
  {type: 'splatling', main: 'バレルスピナーデコ', sub: 'ポイントセンサー', special: 'ダイオウイカ', penalty: '中'},
